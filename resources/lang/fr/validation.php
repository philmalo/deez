...
return [
    ...
    | la classe de validation. Certaines de ces règles ont plusieurs versions telles que les
    | règles de taille. N'hésitez pas à ajuster chacun de ces messages ici.
    |
    */
    ...
    | la convention "attribute.rule" pour nommer les lignes. Cela nous permet de rendre notre message plus expressif,
    | en remplaçant simplement notre espace réservé d'attribut par quelque chose de plus convivial pour le lecteur,
    | comme "Adresse e-mail" au lieu de "email".
    |
    */
